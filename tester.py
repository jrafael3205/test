...
def kyzer6():
    END = '[FBAN/FB4A;FBAV/436.0.0.30525;FBBV/648567057;FBDM/{density=1.5,484=480,height=863};FBLC/en_US;FBRV/648567057;FBCR/Robi;FBCR/Samsung;FBBD/Samsung;FBPN/com.facebook.adsmanager;FBDV/SM-366;FBSV/12.0.0;nullFBCA/armeabi-v7a:armeabi;]'
...
def menu():   
    ...
    print(f'{G1}[{A}2{G2}]{G2} CONTACT TOOL OWNER')
...
#__________________[ PASSWORD ]__________________#
    def pasw(self):       
            pw = []
            clear()
            print(f'{G1}[{A}={G2}]{G2} EXAMPLE {A}:{G2} 5 to 20');linex()
            sl = int(input(f'{G1}[{A}?{G3}]{G3} PASSWORD LIMIT {A}:{G3} '))
            clear()
            print(f'{G1}[{A}?{G4}]{G4} EXAMPLE {A}:{G4} First Last/first last/firstlast')
            linex()
            if sl =='':
