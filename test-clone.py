...
#---------------------[ USER - AGENT ] -------------------#
def uaxxx():
    ua='[FBAN/FB4A;FBAV/287.0.0.84.114;FBPN/com.facebook.lite;FBLC/fr_FR;FBBV/683242437;FBCR/Telefonica;FBMF/OPPO;FBBD/OPPO;FBDV/CPH1941;FBSV/8;FBCA/armeabi;FBDM/{density=3.0,width=1080,height=1920};FB_FW/1;]'
    return ua
def method_crack():
    global methods
    clear()
